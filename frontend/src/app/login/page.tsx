...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 text-slate-50 relative overflow-hidden">
      <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-emerald-500/20 blur-[120px] pointer-events-none" />
      ...
      <div className="w-full max-w-md p-8 glass-panel z-10 animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Log in to your MediMind AI account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div>
            ...
            <input 
              ...
              className="w-full bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-colors"
          ...
          <button type="submit" disabled={isLoading} className="w-full bg-gradient-to-r from-emerald-500 to-cyan-600 text-white font-semibold py-3 rounded-lg hover:shadow-lg hover:shadow-emerald-500/25 transition-all disabled:opacity-50">
